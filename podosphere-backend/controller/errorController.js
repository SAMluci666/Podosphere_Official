...
const handleJWTExpired = () => new AppError(`Token Expires, Please Log in Again!!`, 401);

const handleMulterError = (err) => new AppError(err.message, 409);
...
module.exports = (err, req, res, next) => {
     ...
     */
		...
		else if (error.name === "ValidationError") error = handleDBValidationError(error);
